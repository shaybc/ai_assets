...
description: Standards for implementing and evaluating LaunchDarkly feature flags to ensure consistency, observability, safe rollouts, and predictable behavior across environments.
version: '1.0.0'
